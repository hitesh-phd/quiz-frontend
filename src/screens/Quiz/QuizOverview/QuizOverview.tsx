...
// type Props = {
//   navigation: NativeStackNavigationProp<RootStackParams, "QuizOverview">;
//   route: any;
// };

type Props = NativeStackNavigationProp<RootStackParams, "QuizOverview">;

const QuizOverview: React.FC<Props> = ({ categoryId }: Props) => {
